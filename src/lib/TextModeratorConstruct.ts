...
export class TextModeratorConstruct extends Construct {
  constructor(
    ...
    const textModeratorFunction = new DockerImageFunction(
      ...
      {
        description: lambdaBuilderConstruct.prefix + "textModeratorFunction",
        code: DockerImageCode.fromImageAsset(
          path.join(__dirname, "..", "..", "lambda", "textModeratorFunction"),
          {
    ...
    lambdaBuilderConstruct.contentLibraryBucket.grantReadWrite(
      textModeratorFunction
    );
    lambdaBuilderConstruct.processingBucket.grantReadWrite(
      textModeratorFunction
    );
    ["json", "txt"].map((ext) =>
